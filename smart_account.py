...
class TacoSmartWalletService:
    ...
    def send_eth(self, user_id: str, recipient: str, amount_eth: float, discord_context: Dict) -> Dict:
        ...
        # Sign and submit
        signed_user_operation = self.porter_service.sign_user_operation(
            user_operation,
            f"Send {amount_eth} ETH to {recipient}",
            discord_context
        )
